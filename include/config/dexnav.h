...
// Flag/var defines
#define DN_FLAG_SEARCHING             FLAG_DEXNAV_SEARCHING     // Searching for mon, change flag to 0 to disasble
#define DN_FLAG_DEXNAV_GET            FLAG_DEXNAV_GET           // DexNav shows in start menu, change flag to 0 to disasble
#define DN_FLAG_DETECTOR_MODE         FLAG_DEXNAV_DETECTOR_MODE // Allow player to find hidden mons, change flag to 0 to disasble
#define DN_VAR_SPECIES                VAR_DEXNAV_SPECIES        // Registered DexNav species, change flag to 0 to disasble
#define DN_VAR_STEP_COUNTER           VAR_DEXNAV_STEP_COUNTER   // Steps for finding hidden Pokémon, change flag to 0 to disasble
